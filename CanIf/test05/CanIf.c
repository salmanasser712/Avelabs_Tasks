...
void CanIf_InitController(uint8 Controller, uint8 ConfigurationIndex)
{
  ...
  CanIf_ControllerModeType mode = CANIF_CS_UNINIT;
    ...
    CanIf_ControllerModeType ControllerMode)
{
  ...
  CanIf_ControllerModeType oldMode = CANIF_CS_UNINIT;
              ...
              const uint8 *CanSduPtr)
{
  ...
  CanIf_ChannelGetModeType mode = (CanIf_ChannelGetModeType)CANIF_CS_UNINIT;
...
{
  CanIf_Arc_ChannelIdType channel = CANIF_CHANNEL_CNT;
...
{
	CanIf_Arc_ChannelIdType __attribute__((unused)) channel = CANIF_CHANNEL_CNT;
